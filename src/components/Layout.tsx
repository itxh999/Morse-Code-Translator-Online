...
import { Radio, Settings, Info, X, Globe, ChevronDown, ArrowUp } from 'lucide-react';
      ...
      <AnimatePresence>
        {isVisible && (
          <motion.button
            ...
            onClick={scrollToTop}
            className="fixed bottom-6 right-6 z-40 p-3 bg-amber-400 hover:bg-amber-300 text-black shadow-lg shadow-amber-400/20 rounded-full transition-all focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 focus:ring-offset-gray-900 group"
            title={textDict.backToTop || 'Back to Top'}
            aria-label={textDict.backToTop || 'Back to Top'}
          >
